...
<div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm p-4" style="border-radius: 16px;">
            ...
            <form action="{{ route('products.update', $product->product_id) }}" method="POST" id="productForm" novalidate>
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="description" id="descInput" class="form-control py-2 bg-light border-0 @error('description') is-invalid @enderror" value="{{ old('description', $product->description) }}" required minlength="5">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-6">
                        ...
                        <select name="product_type" class="form-select py-2 bg-light border-0">
                            <option value="installment" {{ $product->product_type == 'installment' ? 'selected' : '' }}>Installment (Cicilan)</option>
                            <option value="payday" {{ $product->product_type == 'payday' ? 'selected' : '' }}>Payday (Gajian)</option>
                            <option value="micro" {{ $product->product_type == 'micro' ? 'selected' : '' }}>Micro Loan</option>
                            <option value="business" {{ $product->product_type == 'business' ? 'selected' : '' }}>Business</option>
                        </select>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" name="min_amount" id="minAmount" class="form-control py-2 bg-light border-0" value="{{ old('min_amount', $product->min_amount) }}" required min="1000000" step="100000">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="max_amount" id="maxAmount" class="form-control py-2 bg-light border-0" value="{{ old('max_amount', $product->max_amount) }}" required step="100000">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" name="min_tenor" id="minTenor" class="form-control py-2 bg-light border-0" value="{{ old('min_tenor', $product->min_tenor) }}" required min="1">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="max_tenor" id="maxTenor" class="form-control py-2 bg-light border-0" value="{{ old('max_tenor', $product->max_tenor) }}" required min="1">
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <input type="number" step="0.1" name="late_fee_percentage" class="form-control py-2 bg-light border-0" value="{{ old('late_fee_percentage', $product->late_fee_percentage) }}" required min="0" max="100">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // === 3. Form Submit Handler (Bootstrap Style + Swal) ===
        form.addEventListener('submit', function (event) {
            ...
            if (!form.checkValidity()) {
                ...
                Swal.fire({
                    ...
                    text: 'Mohon periksa kembali inputan form Anda (pastikan tidak ada yang merah).',
